...
///@brief class that writes the result to a file than can be read by Matlab.
////
///Very simple first version without much options.
class Writer
{
public:
    ///@brief function that takes a filename, the domain and the result and writes the result in csv 
